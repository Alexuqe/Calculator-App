...
final class ViewController: UIViewController {
    ...
    private lazy var operationLabel: UILabel = {
        let label = getLabel(text: "0")
        return label
    }()
    
    private lazy var secondaryOperationLabel: UILabel = {
        let label = getLabel(
            text: "",
...
extension ViewController {
    ...
    fileprivate func configureNumbers() {
    ...
    fileprivate func configureConstraints() {
        NSLayoutConstraint.activate([
            zeroRowStackView.bottomAnchor.constraint(
                equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: trailingConctraint),
            zeroRowStackView.leadingAnchor.constraint(
                equalTo: view.leadingAnchor, constant: leadingConstraint),
            zeroRowStackView.trailingAnchor.constraint(
                equalTo: view.trailingAnchor, constant: trailingConctraint),
            
            firstRowStackView.bottomAnchor.constraint(
                equalTo: zeroRowStackView.topAnchor, constant: indent),
            ...
            secondRowStackView.bottomAnchor.constraint(
                equalTo: firstRowStackView.topAnchor, constant: indent),
            ...
            thirdRowStackView.bottomAnchor.constraint(
                equalTo: secondRowStackView.topAnchor, constant: indent),
            ...
            topRowStackView.bottomAnchor.constraint(
                equalTo: thirdRowStackView.topAnchor, constant: indent),
            ...
            operationsColumStackView.bottomAnchor.constraint(
                equalTo: topRowStackView.topAnchor, constant: -37),
        ...
        //MARK: - UI Helpers
    fileprivate func addSubview(UIElement: UIView) {
    ...
    fileprivate func getSized(element: UIView, width: CGFloat = 80, height: CGFloat = 80) {
        NSLayoutConstraint.activate([
